! function() {
    ...
    m && p && p.addEventListener("click", (function() {
        ! function(e, t) {
            ...
            n.innerHTML = '<div class="alert alert-' + t + ' alert-dismissible" role="alert">' + e + '<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>', m.appendChild(n)
    ...
    if (null != y) {
        var g = document.querySelector(".btn-scroll-top path"),
            v = g.getTotalLength();
        g.style.transition = g.style.WebkitTransition = "none", g.style.strokeDasharray = v + " " + v, g.style.strokeDashoffset = v, g.getBoundingClientRect(), g.style.transition = g.style.WebkitTransition = "stroke-dashoffset 10ms linear", window.addEventListener("scroll", (function(e) {
            var t = document.body.scrollTop || document.documentElement.scrollTop,
                n = document.documentElement.scrollHeight - document.documentElement.clientHeight,
                o = v - t * v / n;
            g.style.strokeDashoffset = o, (document.body.scrollTop || document.documentElement.scrollTop) >= 50 ? y.classList.add("active-progress") : y.classList.remove("active-progress")
